...
QtObject {
    ...
    property var startScreen: QtObject {
        ...
        readonly property string explanationText: "The Audio Quality Tester is a Python tool with GUI that let's you compare lossy MP3 formats.\nThe aim is to find out at what point a person is no longer able to differentiate the file formats. Currently suppoerted input file formats are MP3 and WAV."
    }
